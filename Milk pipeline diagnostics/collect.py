...
# ========== КОНФИГУРАЦИЯ ==========
CLASSES = ['Milk stone', 'Fat', 'Protein', 'Biofilm', 'Custom']
CLASS_COLORS = {
    'Milk stone': (0, 255, 0),  # Green
    'Fat': (255, 0, 0),  # Blue
    'Protein': (0, 255, 255),  # Yellow
    'Biofilm': (0, 0, 255),  # Red
...
print("   0: Milk stone    1: Fat    2: Protein")
print("   3: Biofilm    4: Custom")
...
while True:
    ...
    if ord('0') <= key <= ord('4'):
        ...
        if CLASSES[selected_class] == "Custom":
            ...
            print("Custom class not selected. Press 4 first to select Custom.")
